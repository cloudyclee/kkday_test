...
async function ajaxGetStories () {
	_api_log( 'ajaxGetStories' );
	await _api_delay();
	return _stories;
}

async function ajaxGetStoryById ( id ) {
	_api_log( 'ajaxGetStoryById', { id } );
	await _api_delay();
	return _stories.find( story => story.id === id );
}

async function ajaxGetStoryByIdUnstable ( id ) {
...
export const apiGetStoryById = ajaxGetStoryById;
export const apiGetStoryByIdUnstable = ajaxGetStoryByIdUnstable;
export const apiGetStoriesMeta = getStoriesMeta;